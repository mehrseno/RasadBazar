<template>
  <div>
    <h4 class="submit-post__title">ثبت آگهی</h4>
    <div
      class="form-category-title form-category-title--with-action"
      data-gtm-vis-first-on-screen-7331304_61="81063172"
      data-gtm-vis-recent-on-screen-7331304_61="85416161"
      data-gtm-vis-total-visible-time-7331304_61="100"
      data-gtm-vis-has-fired-7331304_61="1"
    >
      <div class="form-category-title__name">{{ category }}</div>
      <button
        @click="changeCategory(category)"
        class="
          kt-button kt-button--primary kt-button--inlined
          form-category-title__button
        "
        type="button"
        tabindex="0"
      >
        <span class="kt-text-truncate no-pointer-event">تغییر دسته‌بندی</span>
      </button>
    </div>
    <data-loader
      ...
      @recieveData="getData"
    >
      <form class="submit-post__form-wrapper">
        <div class="json-schema-form-dim dim">
          <div class="json-schema-form">
            <form class="json-schema-form__form" novalidate="">
                  ...
                  <div class="field-template__children">
                    <fieldset id="root">
                      ...
                      <InputTemplate
                        :item="'متراژ'"
                        :placeholder="''"
                        :afterAnnotation="'مترمربع'"
                      />
                      <div class="field-template">
                        <div class="field">
                          <div class="text-field">آگهی‌دهنده</div>
                          <div class="field-template__children">
                            <div
                              id="root_user_type"
                              class="json-schema-form__inline-field"
                            >
                              <div
                                class="json-schema-form__radio-item kt-switch kt-switch--checked"
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div
                                    class="
                                      kt-switch__button kt-switch__button--radio
                                    "
                                  ></div>
                                ...
                                <label
                                  class="kt-switch__label"
                                  for="radio-radio-1gmake5"
                                  >شخصی</label
                                >
                              </div>

                              <div
                                class="json-schema-form__radio-item kt-switch"
                              >
                                <div
                                  class="kt-switch__cell"
                                  role="radio"
                      ...
                      <InputTemplate
                        ...
                        :afterAnnotation="'تومان'"
                      />
                      <InputTemplate
                        :item="'اجاره ماهانه'"
                        :placeholder="'اجاره به تومان'"
                        :afterAnnotation="'اجاره به تومان'"
                      />
                          ...
                          <div class="field-template__children">
                            <div>
                              <div
                                class="
                                  kt-selector-row
                                  kt-selector-row--primary
                                  kt-selector-row--selectable
                                "
                                tabindex="0"
                                role="button"
                              >
                      ...
                      <TextareaTemplate
                        ...
                        :description="'شمارهٔ موبایل'"
                        :messageHelp="
                          ' کد تایید به شماره موبایل شما ارسال خواهد شد. تماس و چت نیز با این شماره انجام می‌شود.' +
                          '\n' +
                          ' توجه: لطفا پس از ثبت آگهی، به پیامک‌های پرداخت وجد بی اعتنا باشید.'
                        "
                      />

                      <TextareaTemplate
                        :placeholder="'مثال: آپارتمان، ۰ متر، ولیعصر'"
                        :description="'عنوان آگهی'"
                        :messageHelp="' در عنوان آگهی به موارد مهمی مانند نوع ملک، متراژ و محله اشاره کنید.'"
                      />
                      <TextareaTemplate
                        :placeholder="'توضیحات را بنویسید'"
                        :description="'توضیحات آگهی'"
                        :messageHelp="' در توضیحات آگهی به مواردی مانند شرایط اجاره، جزئیات و ویژگی‌های قابل توجه، دسترسی‌های محلی و موقعیت قرارگیری ملک اشاره کنید.'"
                      />
                    </fieldset>
                  </div>
                </div>
              ...
              <div
                class="
                  kt-button-row kt-button-row--padded kt-button-row--responsive
                "
              >
                <a
                  class="kt-button kt-button--outlined submit-post__cancel"
                  role="button"
                  tabindex="0"
                  href="/s/abdanan"
                  ><span class="kt-text-truncate no-pointer-event"
                    >انصراف</span
                  ></a
                ><button
                  class="kt-button kt-button--primary"
                  type="submit"
                  tabindex="0"
                >
                  <span class="kt-text-truncate no-pointer-event"
...
import TextareaTemplate from "../components/TextareaTemplate.vue";
...
export default {
  ...
  methods: {
    ...
    async getData(data) {
      console.log(data)
      this.cities = data[1].data.slice();
      this.filters = data[2].data.slice()
    },
  },
};
</script>
...
.form-category-title--with-action {
...
.form-category-title--with-image .form-category-title__name,
.form-category-title__name {
  font-weight: 500;
  line-height: 1.5;
  /* font-size: 1.25rem; */
...
.submit-post__form-wrapper {
  margin-top: -16px;
}
.json-schema-form-dim {
  min-height: 90px;
}
.dim {
  position: relative;
...
.json-schema-form__form {
  text-align: right;
  display: flex;
  flex-direction: column;
}
.field-template--compact,
.field-template--compact:first-of-type,
.field-template:first-of-type {
  margin-top: 16px;
}
.field-template {
  /* margin-top: 16px; */
...
.input-and-label {
  ...
  transition: margin-right 0.36s ease, padding-right 0.36s ease,
    color 0.36s ease;
}
...
.submit-location-map-container > .submit-location-map {
  height: 14rem;
}
...
element.style {
  z-index: 17;
  transform: translate3d(276px, 61px, 0px) scale(0.5);
}
...
element.style {
  z-index: 16;
  transform: translate3d(184px, 41px, 0px) scale(0.25);
}
.leaflet-image-layer,
.leaflet-marker-icon,
.leaflet-marker-shadow,
...
.leaflet-tile-container.leaflet-zoom-animated {
  z-index: 18;
  transform: translate3d(-65px, -5px, 0px) scale(1);
}
...
.leaflet-tile.leaflet-tile-loaded {
  width: 256px;
  height: 256px;
  transform: translate3d(200px, -120px, 0px);
  opacity: 1;
}
.map-cm__button:not(:last-child) {
  margin-bottom: 8px;
}
.map-cm__button {
  padding: 0;
...
.field-template .messages,
.field-template .messages.ui.message {
  margin-top: 10px;
}
.messages--help,
...
.kt-icon-photo-o:before {
  content: "\e9cb";
}
.kt-select__arrow:hover {
...
.kt-textfield .kt-textfield__end-icon,
.kt-textfield .kt-textfield__input,
.kt-textfield .kt-textfield__label,
.kt-textfield .kt-textfield__label-background,
.kt-textfield .kt-textfield__label-span,
.kt-textfield .kt-textfield__start-icon {
  position: absolute;
  height: 2.5rem;
  line-height: 2.5rem;
}
...
.kt-switch__button--radio:after {
  ...
  /* -webkit-transform: scale(0); */
  transform: scale(0);
  /* transition: background-color .24s ease,opacity .24s ease,-webkit-transform .24s ease; */
  ...
  transition: background-color 0.24s ease, opacity 0.24s ease,
    transform 0.24s ease, -webkit-transform 0.24s ease;
}
.kt-switch__rippler {
  width: 100%;
  height: 100%;
...
.json-schema-form__inline-field
  .json-schema-form__radio-item
  + .json-schema-form__radio-item {
  margin-right: 32px;
}
...
.kt-selector-row--primary .kt-selector-row__title {
  color: #a62626;
  font-weight: 500;
}
...
.kt-breadcrumbs--single .kt-breadcrumbs__item,
.kt-breadcrumbs__item:nth-last-child(2) {
  display: flex;
  flex-direction: row-reverse;
}

.kt-breadcrumbs--single .kt-breadcrumbs__item .kt-breadcrumbs__icon,
.kt-breadcrumbs__item:nth-last-child(2) .kt-breadcrumbs__icon {
...
.kt-icon-chair::before {
  content: "\e992";
}
.kt-icon-dice::before {
  content: "\ea09";
}
.kt-icon-watch::before {
  content: "\e9f8";
}
...
.kt-icon-electronic-devices::before {
  content: "\e96f";
}
...
.kt-switch__icon-check {
  ...
  -webkit-animation: kt-switch-uncheck 0.2s ease-out forwards;
  animation: kt-switch-uncheck 0.2s ease-out forwards;
}
/* polyline[Attributes Style] {
    transform: translate(5.97487, 2.35355) rotate(-45deg) translate(-5.97487, -2.35355);
} */
:not(svg) {
...
.footer__divider.kt-divider--vertical {
  height: 16px;
}
.kt-divider--vertical {
  display: inline-block;
